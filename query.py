...
def baidu_query(pageindex,keyword,sitename):
...
def main():
	...
	parser.add_argument('sitename', metavar='sitename', type=str, nargs='+', help='an sitename "example:baidu" in ranking')

	args = parser.parse_args()
	print "开始工作"
	for x in range(10,1000,10):
		if baidu_query(x,args.keyword[0],args.sitename[0]) :
			break
main()
